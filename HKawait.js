...
async function waitClickNavigate(selector) { // function for wait , click and navigate
    try {
...
async function handleLockBtn(selector) { // for handling editorial lock button whether it appears or not
    try {
